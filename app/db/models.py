...
class HpxTunnel(Base, CreatedAtUTCMixin):
    ...
    docker_image: Mapped[str] = mapped_column(String(128), default="hpx-icmp:0.0.3")
...
class ShopConfig(Base, CreatedAtUTCMixin):
    ...
    # Payment gateways (each independently toggleable)
    pay_card_enabled: Mapped[bool] = mapped_column(server_default="1", default=True)
    pay_zarinpal_enabled: Mapped[bool] = mapped_column(server_default="0", default=False)
    pay_zarinpal_merchant_id: Mapped[str | None] = mapped_column(String(64), default=None)
    pay_zarinpal_sandbox: Mapped[bool] = mapped_column(server_default="0", default=False)
    pay_idpay_enabled: Mapped[bool] = mapped_column(server_default="0", default=False)
    pay_idpay_api_key: Mapped[str | None] = mapped_column(String(128), default=None)
    pay_idpay_sandbox: Mapped[bool] = mapped_column(server_default="1", default=True)
    pay_nowpayments_enabled: Mapped[bool] = mapped_column(server_default="0", default=False)
    pay_nowpayments_api_key: Mapped[str | None] = mapped_column(String(128), default=None)
    pay_nowpayments_ipn_secret: Mapped[str | None] = mapped_column(String(128), default=None)
    pay_paypal_enabled: Mapped[bool] = mapped_column(server_default="0", default=False)
    pay_paypal_client_id: Mapped[str | None] = mapped_column(String(128), default=None)
    pay_paypal_client_secret: Mapped[str | None] = mapped_column(String(128), default=None)
    pay_paypal_sandbox: Mapped[bool] = mapped_column(server_default="1", default=True)
    pay_stripe_enabled: Mapped[bool] = mapped_column(server_default="0", default=False)
