...
export default function ApiKeysPage() {
  ...
  return (
    <div className="flex w-full flex-col items-start">
      ...
      <ResourcePageShell sectorIndex="05-K" sectorLabel="Credential Vault" description="Programmatic credentials, lifecycle state and revocation controls" stateLabel="Vault ready">
