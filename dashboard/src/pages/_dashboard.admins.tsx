...
export default function AdminsPage() {
  ...
  const handleEdit = (admin: AdminDetails) => {
    ...
    form.reset({
      ...
      create_budget_enabled: admin.create_budget_enabled ?? false,
  ...
  return (
    <div className="flex w-full flex-col items-start">
      ...
      <ResourcePageShell
        sectorIndex="02-A"
        sectorLabel="Operator Registry"
        description="Privileged identities, access posture and delegated control"
        stateLabel="Live registry"
        telemetry={<AdminsStatistics counts={adminCounts} />}
      >
        <div>
