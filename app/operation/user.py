...
class UserOperation(BaseOperation):
    ...
    async def create_user(
        ...
        all_groups = await self.validate_all_groups(db, new_user, None if skip_role_limits else admin)
    ...
    async def _apply_modified_user(
        ...
        *,
        ...
        self._apply_explicit_null_ip_limit(db_user, modified_user)
        try:
    ...
    async def bulk_apply_template_to_users(
        ...
        try:
            for db_user, modified_user_model, validated_groups, _, _ in prepared_updates:
                ...
                self._apply_explicit_null_ip_limit(db_user, modified_user_model)
                await crud_modify_user(
                    db,
                    db_user,
                    modified_user_model,
