  ...
  return (
    <div className="space-y-6">
      <CoreEditorDataTable
        ...
        toolbarActions={
          <>
            <Button type="button" size="sm" className="h-9 px-2 sm:px-3" onClick={beginAddOutbound}>
              <Plus className="h-4 w-4" />
              <span className="hidden sm:inline">{t('coreEditor.outbound.add', { defaultValue: 'Add outbound' })}</span>
            </Button>
            <Button
              type="button"
              variant="outline"
