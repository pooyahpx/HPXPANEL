  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        display: ['Chakra Petch', 'Vazirmatn', 'Inter', 'ui-sans-serif', 'system-ui', 'sans-serif'],
        hud: ['Inter', 'Vazirmatn', 'ui-sans-serif', 'system-ui', 'sans-serif'],
        mono: ['ui-monospace', 'SFMono-Regular', 'Menlo', 'Consolas', 'monospace'],
        pixel: ['Pixelify Sans', 'Vazirmatn', 'ui-sans-serif', 'system-ui', 'sans-serif'],
