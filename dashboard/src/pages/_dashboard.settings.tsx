...
import { Bell, Database, Fingerprint, HardDriveDownload, ListTodo, Palette, Send, Settings as SettingsIcon, ShieldCheck, Webhook } from 'lucide-react'
...
const allTabs: SectorTab[] = [
  ...
  { id: 'backup', label: 'settings.backup.title', icon: HardDriveDownload, url: '/settings/backup' },
  { id: 'security', label: 'security.title', icon: ShieldCheck, url: '/settings/security' },
...
export default function Settings() {
  ...
  const tabs = allTabs.filter(tab => {
    ...
    if (tab.id === 'security') return true
      ...
      <div className="flex w-full flex-col items-start gap-0">
        ...
        <div className="relative w-full">
          <div className="flex w-full min-w-0 flex-col">
            <SectorTabBar tabs={tabs} activeId={activeTab} sector="Control plane" index="04" onSelect={tab => navigate(tab.url)} />
            <div>
              <Outlet />
            </div>
          </div>
