...
export type IpsecSectionNavItem = {
  id: IpsecCoreSection
  labelKey: string
  defaultLabel: string
  icon: LucideIcon
...
export const IPSEC_CORE_SECTION_NAV: IpsecSectionNavItem[] = [
  { id: 'configuration', labelKey: 'coreEditor.section.configuration', defaultLabel: 'Configuration', icon: Cable },
  { id: 'advanced', labelKey: 'coreEditor.section.advanced', defaultLabel: 'Advanced', icon: Braces },
]
