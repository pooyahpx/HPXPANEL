...
export default function HostsPage() {
  ...
  return (
    <div className="flex w-full flex-col items-start pb-8">
      ...
      <ResourcePageShell sectorIndex="04-H" sectorLabel="Endpoint Matrix" description="Routed destinations, transport profiles and priority order" stateLabel="Live topology">
        <MainSection
          data={data}
