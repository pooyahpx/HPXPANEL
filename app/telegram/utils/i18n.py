...
STRINGS: dict[str, dict[str, str]] = {
    "fa": {
        ...
        "admin_ask_plan_ip_limit": "🌐 محدودیت IP همزمان را بفرستید (مثلاً 2) یا - برای نامحدود:",
        "admin_ask_plan_hwid_limit": "📱 محدودیت HWID را بفرستید:\n• عدد (مثلاً 3) = حداکثر دستگاه\n• 0 = بدون HWID\n• - = پیش‌فرض پنل",
    ...
    "en": {
        ...
        "admin_ask_plan_ip_limit": "🌐 Send concurrent IP limit (e.g. 2) or - for unlimited:",
        "admin_ask_plan_hwid_limit": "📱 Send HWID limit:\n• number (e.g. 3) = max devices\n• 0 = disable HWID\n• - = panel default",
